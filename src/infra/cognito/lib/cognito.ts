...
export class CognitoStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const callbacks: string[] = ['https://localhost:7017/signin-oidc', 'http://localhost:7017/signin-oidc'];
  ...
  const listAttach = new cognito.CfnUserPoolUserToGroupAttachment(this, 'listAttachment', {
...
const writeAttach = new cognito.CfnUserPoolUserToGroupAttachment(this, 'writeAttach', {
...
const identityPool = new cognito.CfnIdentityPool(this, 'IdentityPool', {
 ...
 const roles =  new Map<string, string>([["role1", listRoleArn], ["role2", writeRoleArn]])

 const cfnIdentityPoolRoleAttachment = new cognito.CfnIdentityPoolRoleAttachment(this, 'IdentityPoolRoleAttachment', {
...
new CfnOutput(this, 'Authority', {
  ...
  description: "Authority name used for authorithy check by resource servers",
  exportName: "Auth",
});
